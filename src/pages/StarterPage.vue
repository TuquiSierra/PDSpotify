<template>
  <div class="starter-page">
    <div class="section text-center" style="margin: 20px 50px">
      <h3>Spotify: Tendencias musicales</h3>
      <h1 class="h1-seo">¿Lenguaje universal?</h1>
      ...
      <p style="text-align: justify">
        ...
        fundamentales de la construcción de ese túnel.
      </p>
      <div class="row">
        <div class="col-md-4">
          <p style="text-align: justify">
            La modalidad de <i>streaming</i> ha cobrado especial importancia en
            los últimos años. Se estima que a partir de 2018 aumentan en más de
            un 20% los ingresos por esta vía y que, por el contrario, las ventas
            físicas decaen en aproximadamente un 10%. Incluso, según
            <i>billboard</i>, las ganancias por <i>streaming</i> han sostenido
            la industria musical durante la crisis sanitaria. Si se habla de
            estas plataformas es obligatorio mencionar a <b>Spotify</b>. Con una
            base de suscriptores que <b>asciende</b> de 207 millones de usuarios
            mensuales en 2018 a <b>217 millones</b> en 2019 (con un crecimiento
            a usuarios de pago de 31%); <b>Spotify</b> sugiere una
            <b>confiable</b> fuente de información acerca de
            <b>tendencias</b> musicales globales.
          </p>
        </div>
        <div class="col-md-8">
          <div class="card" style="margin-top: 2%">
            <h4>Consumo musical en 2019-2020</h4>
            <div class="row">
              <div class="col-md-4" style="margin-top: 30px">
                <donut-chart
                  style="width: 300px"
                  :percents="[21, 7.2, 56.1, 15.7]"
                  :labs="['Físico', 'Digital', 'Streaming', 'Otros']"
                />
              </div>
              <div class="col-md-7" style="margin-left: 20px">
                <bar-chart
                  :series="[36, 18, 13, 10]"
                  :labs="['Spotify', 'Apple Music', 'Amazon', 'Tencent']"
                />
              </div>
            </div>
          </div>
      ...
      <p style="text-align: justify">
        ...
        que muestra al mercado anglosajón como pauta de la industria musical. Si
        bien el Reino Unido comenzó el trabajo dejándonos el legado de quienes
        se llamaron más famosos que Dios, o de quienes hallaron simpatía por el
        Diablo; ha sido América del Norte quien se ha consolidado como la
      ...
      <div class="row">
        <div class="col-md-7">
          <p style="text-align: justify; margin-top: 2%">
            Sin embargo, el fenómeno es más complejo. Es la industria
            estadounidense, sí, el que da impulso y visibilidad a las nuevas
            tendencias, desde su potente infraestructura empresarial: el único
            país de Latinoamérica que se encuentra entre los 10 primeros
            productores es Brasil. Sin embargo, es desde la música latina que se
            genera la moda en los últimos años. <i>Spotify</i> demuestra, en el
            período analizado, que existe una presencia implacable de artistas
            latinos dominando el <i>hit parade</i>. Los géneros dominantes son
            el <b>rap</b>, <b>trap</b>, <b><i>reggaeton</i></b
            >, representados desde orígenes latinoamericanos: los principales
            exponentes son <i>Bad Bunny</i>, <i>J. Balvin</i> y <i>Anuel</i>,
            quienes registran al menos una canción como promedio en el
            <i>top 100</i> semanal en el período 2017-2020.
          </p>
        </div>
        <div class="col-md-5">
          <div class="card" style="margin-top: 2%">
            <h5 style="margin-top: 5%">
              Promedio de canciones por artista en el <i>top 100</i> semanal
            </h5>
            <bar-chart
              style="margin-right: 5%"
              height="80%"
              :series="[1.47, 1.26, 1.19]"
              :labs="['Bad Bunny', 'Anuel', 'J Balvin']"
            />
          </div>
        </div>
      </div>
      ...
      <p style="text-align: justify">
        ...
        <b>potencia cultural</b> con una fuerte industria musical nacional. La
        influencia de Brasil en el mercado musical mundial ha sido, de cierto
        modo, indirecta. Por un lado, los ritmos brasileños como el
        <i>bossa nova</i> o la <i>samba</i> son una parte incuestionable del
        patrimonio musical de todos los tiempos; pero, si observamos el fenómeno
        desde el punto de vista del consumo de música endémica, éste se ve
        limitado por la barrera del idioma: el portugués no se encuentra tan
        extendido como el español o el inglés. Sin embargo, en los últimos años
        se ha promovido la inserción de dos géneros en el mercado mundial: el
        sertanejo y el <i>brazilian funk</i>. El primero, como derivación de la
        samba, nos lleva al Brasil que conocemos; el segundo, propone un toque
        moderno que renueva lo tradicional y logra fundirse con la base del
        popular <i>funk</i>.
      </p>

      <p style="text-align: justify">
        A pesar de que existe una tendencia a la occidentalización, el caso de
        potencias como Japón, Corea del Sur y China se ha tornado particular.
        Desde poco antes de 2018 Japón se encuentra en el segundo lugar del
        mercado de <i>streaming</i>
        mundial. La cultura asiática ha logrado insertarse en la industria
        musical internacional logrando un híbrido conformado por elementos la
        música occidental mezclados originalmente con pinceladas de una cultura
        que nos resulta lejana. Uno de los ejemplos más ilustrativos es el
        fenómeno del KPop, una especie de derivación del popular género que
        tiene origen en Corea del Sur. La imagen andrógina de los integrantes es
        sólo uno de los elementos que hacen especiales a bandas como la aclamada
        BTS, que se encuentra entre los más populares en el último quinquenio,
        especialmente en la comunidad de 12-15 años. La estética asiática se ha
        expandido principalmente a través de la industria cinematográfica, con
        afluentes fuertes en los dibujos animados; pero, definitivamente en los
        últimos años la música se ha tornado una alternativa cada vez más
        importante para su inserción en la cultura global.
      </p>
      <p style="text-align: justify">
        La música siempre ha sido una vía de sublimación los cambios sociales. A
        pesar de que los inicios del feminismo como movimiento reconocido se
        remonta a inicios del siglo XX, en los últimos años se ha fortalecido la
        demanda de igualdad, con la bandera del empoderamiento femenino. Por
        supuesto, la tendencia musical no puede estar ajena a este fenómeno:
        especialmente como representantes de la música latina, surgen ídolos
        femeninos que se muestran como mujeres poderosas: <i>Carol G.</i>, quien
        con el tema <i>Tusa</i> ocupó el primer lugar durante varias semanas a
        principios de año; <i>Becky G.</i>, que a sus 23 años se coloca como
        artista latina de influencia; o Rosalía, un novedoso fenómeno que
        fusiona la música tradicional española con los ritmos actuales en su
        álbum <i>El mal querer</i>, que, además de hacerla increíblemente
        famosa, hizo ganar visibilidad a un ritmo tan antiguo como es el
        flamenco.
      </p>
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="card">
            <h5 style="margin-top: 5%">
              Índice de homogeneidad interna en los grupos
            </h5>
            <radar-chart />
          </div>
        </div>
        <div class="col-md-7">
          <p style="text-align: justify">
            Si comparamos los niveles de similitud interna a lo largo del
            tiempo, podemos constatar que evidentemente se produce una
            homogeneización de los grupos, especialmente de los representativos
            de ciertas pautas culturales universales. Podemos extraer también
            que existen naciones más resistentes a la penetración, y que se
            agrupan como las ovejas negras del rebaño para mantener un discreto
            crecimiento de las similitudes internas.
          </p>
        </div>
      </div>
      <p style="text-align: justify">
